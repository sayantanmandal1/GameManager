    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#101310]/90 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-6">
          <Link href="/games" className="flex items-center gap-2 text-white">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#252923] text-lg" aria-hidden="true">
            {user?.avatar ?? 'G'}
          </span>
          <button
            type="button"
            ...
            className="min-h-9 rounded-lg px-3 text-sm font-semibold text-game-muted transition-colors hover:bg-white/5 hover:text-white"
          >
            Sign out
          </button>
        </div>
